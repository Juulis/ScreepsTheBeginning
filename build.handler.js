...
var builder = {
    ...
    buildManager: function (room) {
        ...
        const buildExtensions = (room, spawnPos) => {
            ...
            if (room.controller.level > 3 && totalExtensions < 15 && totalExtensionConstructionsites < 0) {
                console.log("building second extensions at ", spawnPos);
        ...
        const buildStorage = (room, buildPos) => {
            ...
            if (room.memory.stage > 3 && !hasStorageConstructionSite && totalStorages < 1 && helper.getEmpireEnergyCapacity() > 800 && controllerLvl > 3) {
